...
# Second iteration
simhash_1_str = str(simhash_1.value)
simhash_2_str = str(simhash_2.value)
simhash_1_1 = Simhash(get_features(simhash_1_str))
simhash_2_1 = Simhash(get_features(simhash_2_str))

print ('%x' % simhash_1_1.value)
print ('%x' % simhash_2_1.value)

print (Simhash(str(simhash_1.value)).distance(Simhash(str(simhash_1.value))))
print (Simhash(str(simhash_1.value)).distance(Simhash(str(simhash_2.value))))